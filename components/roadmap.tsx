        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li className="flex-start group relative flex lg:flex-col">
              ...
              />
              <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200  group-hover:bg-gradient-to-b group-hover:from-[#FF72E1] group-hover:to-[#F54C7A]">
                <svg
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Ready to get started? Simply click on &apos;Choose
                  Resume&apos; below to upload your resume. Please note, we
                  currently support only PDF format.
                </h4>
              </div>
            </li>
            <li className="flex-start group relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  AIMO will run your resume through ATS to get the details, and
                  will create an ATS score based on various parameters.
                </h4>
              </div>
            </li>
            <li className="flex-start group relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  The model will rewrite your resume and provide personalized
                  tips to enhance your score, along with steps to improve the
                  details in your resume.
                </h4>
              </div>
            </li>
            <li className="flex-start group relative flex lg:flex-col">
              <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 transition-all duration-200  bg-gradient-to-b from-[#FF72E1] to-[#F54C7A]">
                <svg
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Discover, build, and land your dream job with our easy, guided
                  steps.
                </h4>
              </div>
            </li>
